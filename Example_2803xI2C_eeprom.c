...
//!  <h1>I2C GY_80(i2c_imu)</h1>
//!
//!  This program requires an external I2C IMU connected to
//!  the I2C bus at address 0x53.
//!
//!  The data written and the IMU address written to are contained
